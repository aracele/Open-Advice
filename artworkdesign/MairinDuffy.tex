\chapterwithauthor{Máirín Duffy Strode}{Não seja tímido}

\authorbio{Máirín Duffy Strode tem usado Software Livre e Open Source desde o ensino
médio, e tem sido uma contribuidora há 8 anos. Ela está envolvida 
nas comunidades Fedora e GNOME e tem trabalhado com design de interação,
gestão de marcas (branding), e/ou iconografia para um número de proeminentes aplicações
FOSS tais como Spacewalk, Anaconda, virt-manager, SELinux e SSSD. Ela também tem estado 
envolvida com projetos de ensino de habilidades de design para crianças usando ferramentas FOSS
tais como GIMP e Inkscape e é uma feroz defensora destas ferramentas. Ela é líder do
Fedora Design Team e designer de interação sênior na Red Hat, Inc.}
